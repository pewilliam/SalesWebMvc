...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public SeedingService(SalesWebMvcContext context) // Quando o seeding service for iniciado, vai receber uma instanciação do SaleWebMvcContext também
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            }// testando se há dado na database
            ...
            Seller s1 = new Seller(1, "Tiago Santiago", "tiago@gmail.com", new DateTime(2001, 10, 30), 1000.0, d1);
            Seller s2 = new Seller(2, "Saullo Felix", "saullo@gmail.com", new DateTime(1999, 5, 20), 2500.0, d2);
            Seller s3 = new Seller(3, "Fernanda Souza", "fernanda@gmail.com", new DateTime(1995, 1, 7), 2000.0, d3);
            Seller s4 = new Seller(4, "Lucas Souza", "lucas@gmail.com", new DateTime(2002, 11, 19), 1750.0, d4);
            Seller s5 = new Seller(5, "Jean Silva", "jean@gmail.com", new DateTime(2001, 7, 30), 4000.0, d1);
            Seller s6 = new Seller(6, "Yan Lima", "yan@gmail.com", new DateTime(1999, 8, 4), 3300.0, d2);
